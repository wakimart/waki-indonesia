window.onload = function(){
  ...
  function uiZoom(e){
	...
	*/
	var options = {
	  zoomWidth: (e.getAttribute('lens-width') != null)?parseInt(e.getAttribute('lens-width')):200,
	  borderRadius: (e.getAttribute('border-radius') != null)?parseInt(e.getAttribute('border-radius')):0,
	...
	*/
	...
	ZoomLens.style.marginTop = 0+'px';
  ZoomLens.style.marginLeft = 4.5+'em';
