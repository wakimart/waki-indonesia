    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <h4 class="text-center" style="font-size: 50px; font-family: 'Poppins', sans-serif; font-weight: 500; color: #f0bc5e;">
                Selamat Bpk/Ibu {{ $publichomecare['name'] }}
            </h4>
        </div>
        <div class="row justify-content-center">
                ...
                <ul class="responsive-table">
                    ...
                    <li class="table-row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" data-label="Jadwal">
                            {{ date("d/m/Y", strtotime($publichomecare->start_date)) }} - {{ date("d/m/Y", strtotime($publichomecare->end_date)) }}
                        </div>
                        <div class="col-lg-4 col-md-3 col-sm-3 col-xs-3" data-label="Nama Produk">
                            {{ $publichomecareproduct->personalHomecareProduct->product['code'] }} - {{ $publichomecareproduct->personalHomecareProduct->product['name'] }}
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3" data-label="Kode Produk">
                            {{ $publichomecareproduct->personalHomecareProduct->code }}
                        </div>
                    </li>
                    @endforeach
                </ul>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <div class="card-body">
                                        ...
                                        <p style="font-weight: 500;">{{ date("d/m/Y H:m:i", strtotime($publichomecare->created_at)) }}</p>
                                    </div>
                                </div>
                            </div>
