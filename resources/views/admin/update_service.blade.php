	          		...
	          		<div class="card-body">
	            		<form id="actionAdd" class="forms-sample" method="POST" action="{{ route('update_service') }}">
			                ...
			                <div id="tambahan_productservice"></div>
	              			...
	              			@php $total_productservice = count($services->product_services); @endphp
	...
	$(document).ready(function(){
	    ...
	    $("#actionAdd").on("submit", function (e) {
	        ...
	        for (var i = 0; i < idService; i++) {
	        	...
	        	arr_productService.push([id_service, id_product_service, product, arr_issues, issues, due_date, other]);
	        }
