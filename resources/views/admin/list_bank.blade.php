...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">List Bank</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive"
                                ...
                                <tbody>
                                    @foreach ($banks as $key => $bank)
                                        <tr>
                                            ...
                                            @can('edit-bank')
                                            <td class="center">
                                                <a href="{{ route('edit_bank', ['id' => $bank['id']]) }}">
                            ...
                            <br>
                            <?php echo $banks->appends($url)->links(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function (e) {
    $("#btn-filter").click(function (e) {
        ...
        window.location.href = "{{route('list_bank')}}" + urlParamStr;
    });
});
