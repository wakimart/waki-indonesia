...
$menu_item_second_sub = "list_order_report_branch";
?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @php
                                            ...
                                            $paramReportCso['filter_cso'] = $order_report['code'];
                                        @endphp
                                        <a href="{{ route('admin_list_order_report_cso', $paramReportCso) }}" target="_blank">
...
$(document).on("click", "#btn-filter", function (e) {
    ...
    window.location.href = "{{route('admin_list_order_report_branch')}}" + urlParamStr;
});
</script>
@endsection
