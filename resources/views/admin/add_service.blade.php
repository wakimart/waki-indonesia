							...
							<div class="form-group">
	              			...
	              			<div class="form-group" id="container-productservice-0">
			                    ...
			                    <div id="container-sparepart-0">
			                    	<div id="detailSparepart-0">
			                    		<div class="form-group" style="width: 72%; display: inline-block;">
					                        <select id="idSparepart-0-0" class="form-control pilihan-product" data-msg="Mohon Pilih Product" required="">
			                    ...
			                    <div class="form-group">
				                    ...
				                    <textarea class="form-control" id="issues-0" rows="5" data-msg="Mohon Isi Issues" placeholder="Description"></textarea>
				                    <div class="validation"></div>
				                </div>
					...
					<div id="container-productservice-'+detailProductService+'">\
						...
						<div id="container-sparepart-'+detailSparepart+'">\
							<div id="detailSparepart-'+detailSparepart+'">\
								<div class="form-group" style="width: 72%; display: inline-block;">\
									<select id="idSparepart-0-'+detailSparepart+'" class="form-control pilihan-product" name="sparepart[]" data-msg="Mohon Pilih Sparepart" required="">\
										<option selected disabled value="">Choose SPAREPART</option>\
						...
						<div class="form-group">\
						    ...
						    \
							<textarea class="form-control" id="issues-'+detailProductService+'" rows="5" data-msg="Mohon Isi Issues" placeholder="Issues"></textarea>\
							<div class="validation"></div>\
						</div>\
						<div class="form-group">\
							<label for="">Due Date</label>\
