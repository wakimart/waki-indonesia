...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Data Therapy</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="actionAdd"
                            class="forms-sample"
                            method="POST"
                            action="{{ route('update_data_therapy') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="no_ktp" id="no_ktp" value="{{ $data_therapy['no_ktp'] }}" placeholder="Nomor KTP" required data-msg="Mohon Isi Nomor KTP"/>
                                <span class="invalid-feedback">
                                    <strong></strong>
                                </span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="phone" id="phone" value="{{ $data_therapy['phone'] }}" placeholder="Nomor Telepon" required data-msg="Mohon Isi Nomor Telepon"/>
                                <span class="invalid-feedback">
                                    <strong></strong>
                                </span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="5" data-msg="Mohon Isi Alamat" placeholder="Alamat">{{ $data_therapy['address'] }}</textarea>
                                <span class="invalid-feedback">
                                    <strong></strong>
                                </span>
                            </div>
                            ...
                            <div class="form-group">
				                ...
				                <select class="form-control" id="typecustomer" name="type_customer_id" required data-msg="Mohon Pilih Type Customer" >
			                        ...
			                        @foreach($type_customers as $type_customer)
			                            <option value="{{ $type_customer['id'] }}" @if($type_customer['id'] == $data_therapy['type_customer_id']) selected @endif>
                                            {{ $type_customer['name'] }}
                                        </option>
			                        @endforeach
	                			</select>
                            ...
                            <div class="form-group">
				                ...
				                <select class="form-control" id="branch" name="branch_id" data-msg="Mohon Pilih Cabang" >
			                        ...
			                        @foreach($branches as $branch)
			                            <option value="{{ $branch['id'] }}"  @if($branch['id'] == $data_therapy['branch_id']) selected @endif>
	              			...
	              			<div class="form-group">
                                ...
                                <select id="cso" name="cso_id" class="form-control pilihan-product" data-msg="Mohon Pilih CSO" required>
                                    ...
                                    @foreach ($csos as $cso)
                                        <option value="{{ $cso->id }}"  @if($cso['id'] == $data_therapy['cso_id']) selected @endif>
                                            {{ $cso->code }} - {{ $cso->name }}
                                        </option>
                                    @endforeach
                                </select>
