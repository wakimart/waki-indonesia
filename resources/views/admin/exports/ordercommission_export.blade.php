<table>
    ...
    <tbody>
        ...
        @foreach ($CsoCommissions as $key => $Cso_Commission)
            ...
            @foreach($Cso_Commission->orderCommission as $orderPerCommission)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid black; text-align: left;">
                        {{ $Cso_Commission->cso['code'] }} - {{ $Cso_Commission->cso['name'] }} ({{ $percentage }})
                    </td>
            ...
            @endphp
            @if(sizeof($Cso_Commission->orderCommission) > 0)
                <tr>
                    <td colspan="4" style="font-weight: bold; background-color: #AEF6FC; border: 1px solid black; text-align: center;">{{ $Cso_Commission->cso['code'] }} - {{ $Cso_Commission->cso['name'] }}</td>
