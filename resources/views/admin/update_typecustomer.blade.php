...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Type Customer</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a data-toggle="collapse"
                            href="#type_customer-dd"
                            aria-expanded="false"
                            aria-controls="type_customer-dd">
                            Type Customer
                        </a>
                    </li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="actionAdd"
                            class="forms-sample"
                            method="POST"
                            action="{{ route('update_type_customer') }}">
                            @csrf
                            ...
                            <input type="hidden"
                                name="idTypeCustomer"
                                value="{{ $type_customers['id'] }}" />

                            <button id="updateTypeCustomer"
                                type="submit"
...
<script type="application/javascript">
    $(document).ready(function() {
	    ...
	    function progressHandler(event){
	        document.getElementById("updateTypeCustomer").innerHTML = "UPLOADING...";
	    }
	    function completeHandler(event){
	        ...
	        document.getElementById("updateTypeCustomer").innerHTML = "SAVE";
	    }
