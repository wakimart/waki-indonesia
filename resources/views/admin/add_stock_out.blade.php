...
$menu_item_second = "add_stock_out";
?>
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Stock Out</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="actionAdd" method="POST"
                            action="{{ route("store_stock_in_out") }}" autocomplete="off">
                            @csrf
...
function checkStock(e) {
    ...
    fetch(
        `{{ route("stock_in_out_get_stock") }}?warehouse_id=${warehouse}&product_id=${product}`,
        {
            method: "GET",
            headers: {
                "Accept": "application/json",
        ...
        if (response.quantity === undefined && response.quantity === null) {
            document.getElementById("addHistory").setAttribute("disabled", "");
        ...
        if ((response.quantity - quantity) < 0) {
            ...
            document.getElementById("addHistory").removeAttribute("disabled");
