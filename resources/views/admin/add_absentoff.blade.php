<?php
    ...
    $menu_item_second = "add_absent_off";
?>
...
<div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
            <h3 class="page-title">Add Cuti</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Cuti</li>
              </ol>
            </nav>
      </div>
      ...
      <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                <form id="actionAdd" class="forms-sample" method="POST" action="{{ route('store_absent_off') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ (Auth::user()->cso->name) ?? Auth::user()->name }}" disabled required>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="cso" name="cso_id" data-msg="Mohon Pilih Cso" required
                                ...
                                @foreach ($csos as $cso)
                                <option value="{{ $cso->id }}"
                                    @if(Auth::user()->cso_id == $cso->id) selected @endif>
                                    {{ $cso->code }} - {{ $cso->name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="division" name="division" placeholder="Division" required data-msg="Mohon Isi Division"/>
                        <span class="invalid-feedback">
                            <strong></strong>
                        </span>
                        <div class="validation"></div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="duration_work" name="duration_work" placeholder="Work Since" required data-msg="Mohon Isi Work Since"/>
                        <span class="invalid-feedback">
                            <strong></strong>
                        </span>
                        <div class="validation"></div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date" required data-msg="Mohon Isi Start Date"/>
                            <span class="invalid-feedback">
                                <strong></strong>
                            </span>
                            <div class="validation"></div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="end_date" name="end_date" required data-msg="Mohon Isi End Date"/>
                            <span class="invalid-feedback">
                                <strong></strong>
                            </span>
                            <div class="validation"></div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="duration_off" name="duration_off" required data-msg="Mohon Isi Duration Off"/>
                            <span class="invalid-feedback">
                                <strong></strong>
                            </span>
                            <div class="validation"></div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="work_on" name="work_on" required data-msg="Mohon Isi Work On"/>
                            <span class="invalid-feedback">
                                <strong></strong>
                            </span>
                            <div class="validation"></div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="desc" name="desc" rows="5" required data-msg="Mohon Isi Reason" placeholder="Reason of absent" required></textarea>
                        <span class="invalid-feedback">
                            <strong></strong>
                        </span>
                        <div class="validation"></div>
