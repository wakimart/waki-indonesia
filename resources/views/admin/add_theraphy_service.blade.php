	          		...
	          		<div class="card-body">
	            		<form id="actionAdd" class="forms-sample" method="POST" action="{{ route('store_theraphy_service') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select disabled="" class="form-control" id="type" name="type" data-msg="Mohon Pilih Type" required >
                            ...
                            <div class="form-group therapy_type d-none">
                                ...
                                <input type="text" class="form-control" id="therapy_location" name="therapy_location" placeholder="Therapy Location" value="{{ old('therapy_location') }}">
                            </div>
	              			<div class="form-group">
