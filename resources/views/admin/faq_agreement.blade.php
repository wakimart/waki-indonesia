...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">FaQ Agreement</h3>
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a data-toggle="collapse"
                            href="#"
                            aria-expanded="false"
                            aria-controls="faq_agreement-dd">
                            FaQ Agreement
                        </a>
                    </li>
                </ol>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" id="firstAgreement-tab" data-toggle="tab" href="#firstAgreement" role="tab" aria-controls="firstAgreement" aria-selected="true">Tata Tertib Peraturan</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="secondAgreement-tab" data-toggle="tab" href="#secondAgreement" role="tab" aria-controls="secondAgreement" aria-selected="false">Peraturan Absen</a>
                            </li>
                          </ul>
