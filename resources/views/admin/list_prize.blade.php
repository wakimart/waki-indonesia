...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">List Prize</h3>
                            ...
                            <tbody>
                                <?php foreach ($prize as $value): ?>
                                    <tr>
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td class="center">
                                            <a href="{{ route("edit_prize", ["id" => $value->id]) }}">
