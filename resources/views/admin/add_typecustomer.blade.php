...
$menu_item_second = "add_type_customer";
?>
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Type Customer</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="actionAdd"
                            class="forms-sample"
                            method="POST"
                            action="{{ route('store_type_customer') }}">
                            @csrf
...
<script type="application/javascript">
    $(document).ready(function() {
	    ...
	    function progressHandler(event){
	        document.getElementById("addTypeCustomer").innerHTML = "UPLOADING...";
	    }
	    function completeHandler(event){
	        ...
	        document.getElementById("addTypeCustomer").innerHTML = "SAVE";
	    }
