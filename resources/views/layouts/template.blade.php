...
<body>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N3ZNCDJ"
            height="0"
            width="0"
        ...
        <div class="container">
            <div class="logo float-left">
                <a href="#header" class="scrollto">
                    <img src="{{ asset('sources/Logo Since.png') }}"
                        alt="#"
                        class="img-fluid"
            ...
            <nav class="main-nav float-left d-none d-lg-block scrollto">
                <ul>
                    ...
                    <li class="drop-down"><a href="#product">Produk</a>
                        <ul>
                            @foreach (App\CategoryProduct::all() as $categoryProduct)
                                <li class="drop-down">
                                    <a href="{{ route('product_category', ['id'=> $categoryProduct->id]) }}"
                    ...
                    <li>
                        <a href="{{ route('index') }}#portfolio">Gallery</a>
                    </li>
                    <li>
                        <a href="{{ route('index') }}#footer">Contact Us</a>
                    </li>
                    <li><a href="{{ route('login') }}">Login</a></li>
                    <li>
                        <a href="#" class="searchtxtmob"></a>
                        ...
                        <div class="searchbox" style="display: none;">
                            <form role="search"
                                ...
                                <button id="searchbtn"
                                    type="submit"
                                    class="search-submit btn search-btn">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="social-links">
                                    <h4>Follow Us</h4>
                                    <a href="https://web.facebook.com/wakimart.id"
                                        class="facebook">
                                        <i class="fa fa-facebook"></i>
                                    </a>
                                    <a href="https://www.instagram.com/wakimart.id/"
                                        class="instagram">
                                        <i class="fa fa-instagram"></i>
                                    </a>
                                    <a href="https://www.youtube.com/channel/UCI2G97LQi4lHZ0yQtug1Wqw"
                                        class="youtube">
