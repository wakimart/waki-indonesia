            ...
            <div class="row justify-content-center">
                ...
                <table class="col-md-12">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            {{ $order['district'][0]['province'] }}, {{ $order['district'][0]['kota_kab'] }}, {{ $order['district'][0]['subdistrict_name'] }}
                        </td>
                    </tr>
                </table>
                <table class="col-md-12">
                ...
                <table class="col-md-12">
                    ...
                    <tr>
                        <td>Total Payment: </td>
                        <td>
                            Rp. {{ number_format($order['total_payment']) }}
                        </td>
                    </tr>
                    <tr>
                        <td>Down Payment: </td>
                ...
                <a href="whatsapp://send?text={{ route('detail_order') }}?code={{ $order['code'] }}" data-action="share/whatsapp/share">Share to WhatsAoo</a>
            </div>
        </div>
    </section>
@else
