...
class Order extends Model
{
    ...
    static $status = [
        '1' => 'new', 
        '2' => 'process', 
        '6' => 'stock_request_pending',  
        '7' => 'stock_request_success', 
        '3' => 'delivery', 
        '8' => 'delivered',
        '4' => 'success', 
        '5' => 'reject', 
    ...
    {
        return $this->hasOne('\App\StockOrderRequest');
    }
    public function rejectStock()
    {
        return $this->hasOne('\App\StockInOut', 'id', 'reject_stock_id');
    }
