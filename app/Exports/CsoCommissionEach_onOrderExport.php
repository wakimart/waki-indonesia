...
class CsoCommissionEach_onOrderExport implements FromView, ShouldAutoSize, WithColumnWidths, WithEvents, WithTitle, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        return view("admin.exports.ordercommissioneach_export", ['allCsoCommission' => $this->allCsoCommission
            ,'branch' => $branch
            ,'periode' => $periode
